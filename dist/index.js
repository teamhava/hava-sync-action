...
class HavaExporter {
    ...
    export(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const viewIdResult = yield this.getEnvironmentViewId(options.EnvironmentID, options.ViewType, client);
            ...
            const exportResult = yield this.exportPNG(viewIdResult.Message, client);
            ...
            const pngData = yield client.get(exportResult.Message);
    ...
    getEnvironmentViewId(environmentID, viewType, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (views.length < 1) {
                ...
                core.warning(`Multiple views of type '${viewType}' found, selecting the first one!`);
            }
            return {
                Success: true,
                Message: views[0].id
    ...
    exportPNG(viewId, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.message.statusCode === 422) {
                return {
                    Success: false,
                    Message: `API responded with invalid request: ${JSON.parse(yield result.readBody()).message}`
                };
            }
            if (result.message.statusCode !== 202) {
                return {
                    Success: false,
                    Message: `Unexpected status code returned from Hava API: '${result.message.statusCode}' Error from API: ${yield result.readBody()}`
                };
            }
            const job = JSON.parse(yield result.readBody());
            const jobWaitResult = yield (0, helpers_1.waitForJob)(job.job_id, client);
 ...
 */
function waitForJob(jobId, client) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        let jobActive = true;
        ...
        const reqOptions = {
            headers: (_a = client.requestOptions) === null || _a === void 0 ? void 0 : _a.headers,
            allowRedirects: false
        };
        const newClient = new http_client_1.HttpClient(undefined, undefined, reqOptions);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const sourceId = core.getInput('source_id');
        ...
        if (!skipExport) {
            ...
            const expResult = yield exporter.export(expOptions);
...
class HavaSync {
    ...
    syncSource(sourceId, havaToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const jobResult = yield (0, helpers_1.waitForJob)(job.job_id, client);
